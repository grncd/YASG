...
public class LyricsHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.GetInt("Player1") == 1)
        {
            ...
            temp.GetChild(4).GetComponent<TextMeshProUGUI>().text = PlayerPrefs.GetString("Player1Name");
        ...
        if (PlayerPrefs.GetInt("Player2") == 1)
        {
            ...
            temp.gameObject.SetActive(true);
            temp.GetChild(4).GetComponent<TextMeshProUGUI>().text = PlayerPrefs.GetString("Player2Name");
        ...
        if (PlayerPrefs.GetInt("Player3") == 1)
        {
            ...
            temp.gameObject.SetActive(true);
            temp.GetChild(4).GetComponent<TextMeshProUGUI>().text = PlayerPrefs.GetString("Player3Name");
        ...
        if (PlayerPrefs.GetInt("Player4") == 1)
        {
            ...
            temp.gameObject.SetActive(true);
            temp.GetChild(4).GetComponent<TextMeshProUGUI>().text = PlayerPrefs.GetString("Player4Name");
