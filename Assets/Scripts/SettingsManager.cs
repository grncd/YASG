...
public class SettingsManager : MonoBehaviour
{
    ...
    private void InitializeDefaultSettings()
    {
        _settings = new Dictionary<string, Setting>
        {
            ...
            { "SongOffset", new Setting { Value = "0", Category = SettingCategory.Gameplay, IsHidden = false, UIType = UIType.TextInput, FormalName = "Song Offset", Description = "Offset (in seconds) used when playing the song. Can't be a negative value. Default is 0s. Only change if you know what you're doing."  } },
            { "PitchDataPadding", new Setting { Value = "0.15", Category = SettingCategory.Gameplay, IsHidden = false, UIType = UIType.TextInput, FormalName = "Pitch Data Padding", Description = "Padding (in seconds) added to the start of the song's pitch data at runtime to compensate for microphone processing latency. Ranges between 0s and 1s. Default is 0.15s. Only change this if you know what you're doing."  } },
            { "AudioLatencyCompensation", new Setting { Value = "0.1", Category = SettingCategory.Gameplay, IsHidden = false, UIType = UIType.TextInput, FormalName = "Audio Latency Compensation", Description = "Compensation (in seconds) for audio output latency. Use the calibration tool to set this automatically, or adjust manually. Ranges between 0s and 1s. Default is 0.1s."  } },
