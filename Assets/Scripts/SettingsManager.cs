...
public class SettingsManager : MonoBehaviour
{
    ...
    private void InitializeDefaultSettings()
    {
        _settings = new Dictionary<string, Setting>
        {
            ...
            // Processing
            { "PitchProcessingQuality", new Setting { Value = 1, Category = SettingCategory.Processing, IsHidden = false, UIType = UIType.Dropdown, FormalName = "Pitch Processing Quality", Description = "Higher means more accurate, but the pitch processing stage will take longer.", DropdownOptions = new List<string> { "Low", "Medium", "High" } } },
