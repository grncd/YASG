...
public class SettingsManager : MonoBehaviour
{
    ...
    private void InitializeDefaultSettings()
    {
        _settings = new Dictionary<string, Setting>
        {
            ...
            { "SongOffset", new Setting { Value = "0.26", Category = SettingCategory.Gameplay, IsHidden = false, UIType = UIType.TextInput, FormalName = "Song Offset", Description = "Offset (in seconds) used when playing the song. Can't be a negative value. Default is 0.26s. Only change if you know what you're doing."  } },
            ...
            { "BGResolution", new Setting { Value = 2, Category = SettingCategory.Misc, IsHidden = false, UIType = UIType.Dropdown, FormalName = "Background Resolution", Description = "Lower this to improve GPU performance. Lower resolutions will appear blurry instead of pixelated.", DropdownOptions = new List<string> { "0.25x (Very Low)", "0.5x (Low)", "0.75x (Medium)", "1.0x (Native)" } } },
